  ...
  return (
    <div className="mb-3">
      <div className="flex justify-between text-sm mb-1">
        ...
        <span className="font-semibold text-slate-700">{count} candidates</span>
      </div>
        ...
        <div className="xl:col-span-2">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 h-full flex flex-col">
            ...
            <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center">
              ...
              <span className="bg-indigo-50 text-indigo-700 text-xs font-medium px-2.5 py-1 rounded-full ring-1 ring-inset ring-indigo-600/20">
        ...
        <div className="xl:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 h-full flex flex-col">
            <div className="px-6 py-4 border-b border-slate-200">
              ...
              <p className="text-slate-500 text-xs mt-0.5">All {dummyMetrics.totalResumes} candidates</p>
            </div>
